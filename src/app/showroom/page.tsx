    ...
    return (
        <div className="bg-stone-50 min-h-screen text-stone-900">
            <div className="pt-32 pb-12 px-6 container mx-auto text-center">
                <h1 className="text-4xl md:text-6xl font-serif mb-6 text-[#1c1917]">Our Showroom</h1>
                <p className="text-[#44403c] max-w-2xl mx-auto">Explore our complete collection of design-forward furniture and accessories.</p>
            </div>

            <div className="px-6 container mx-auto pb-24">
                {/* Filter Placeholder */}
                <div className="flex justify-center space-x-6 mb-16 text-sm uppercase tracking-widest text-stone-500">
                    <span className="text-amber-600 cursor-pointer border-b border-amber-600 pb-1">All</span>
                    <span className="hover:text-stone-900 cursor-pointer transition-colors">Living</span>
                    <span className="hover:text-stone-900 cursor-pointer transition-colors">Dining</span>
                    <span className="hover:text-stone-900 cursor-pointer transition-colors">Bedroom</span>
                    <span className="hover:text-stone-900 cursor-pointer transition-colors">Decor</span>
                </div>
