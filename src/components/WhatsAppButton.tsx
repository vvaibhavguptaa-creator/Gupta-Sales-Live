...
// import { FaWhatsapp } from 'react-icons/fa'; // Removed due to build issue
...
const WhatsAppButton = () => {
    return (
        <a
            ...
            className="fixed bottom-6 right-6 z-50 group flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 animate-[pulse_3s_ease-in-out_infinite] cursor-default"
            aria-label="Chat with us on WhatsApp"
        >
            {/* SVG Replacement for FaWhatsapp */}
            <svg
